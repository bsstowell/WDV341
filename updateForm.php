    ...
    <div id="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark">
              ...
              <header style="background-image: url('images/wood-background.jpg'); padding-bottom: 20px">
                ...
                <p>Thank you for updating the record.</p>
                ...
                <?php
                    ...
                    try{
                        ...
                        $sql = "SELECT guest_id, guest_name, guest_email, arrival_date, departure_date, room_theme FROM guest_reservations WHERE
                        guest_id = :guestId";
                        ...
                        echo "Problems updating record from table " . $e->getMessage();
                    }
                ?>
                <div>
               
                <form id="reservation" name="reservation" method="post" action="updateForm.php">
                    ...
                    <p>
                        ...
                        <input type="text" name="arrival" id="arrival" placeholder="mm-dd-YYYY" value="<?php echo $row['arrival_date']; ?>" />
                    </p>
                    <p>
                        <label for="" class="formatLabel">Departure Date:</label> 
                        <input type="text" name="departure" id="departure" placeholder="mm-dd-YYYY" value="<?php echo $row['departure_date']; ?>" />
                    </p>
                    <p>
