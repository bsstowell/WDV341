<?php
    ...
    */
    ...
    $sql = "SELECT product_name,product_description,product_price,product_status,product_inStock, product_image FROM wdv341_products ORDER BY product_name DESC";
