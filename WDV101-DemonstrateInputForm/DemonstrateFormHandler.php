...
<h3>Response Message for assignment 5-1</h3>
...
<div>
	...
	<p>Your School: <?php echo $_POST["school_name"]?></p>
	<p>Your Favorite Color: <?php echo $_POST["colors"]?></p>
	<p>You have selected: <?php echo $_POST["majors"]?> as your new major.</p>
</div>
