              ...
              <header style="background-image: url('images/wood-background.jpg'); padding-bottom: 20px">
                ...
                <div class="flex-container-2" style="width:60%;height:auto;padding-top:10px;background-image:url(images/seamless_paper.webp)">
                    <p style="font-size:20px">
                       We apologize for any inconvenience you have experienced. <br><br>Your merchandise
                       purchase has been canceled. <br><br>Please click on the button below to return to the 
                       merchandise page. <br><br>Thank you.
                    </p>
                </div>
                    <button id="button">
					<a href="https://www.brianstowell.name/WDV341/WildWestResort/merch.php">Wild West Resort Merchandise</a>
				</button>
</header>
        <footer>
