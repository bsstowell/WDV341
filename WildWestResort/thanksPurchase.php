              ...
              <header style="background-image: url('images/wood-background.jpg'); padding-bottom: 20px">
                ...
                <div class="flex-container-2" style="width:60%;height:auto;padding-top:10px;background-image:url(images/seamless_paper.webp)">
                    <p style="font-size:20px">
                       Thank you for your purchase of Wild West Merchandise!<br><br>Your merchandise
                       will be shipped within 3 business days. <br><br>Please check your PayPal account
                       for details on your purchase.
                    </p>
                </div>
                    <button id="button">
					    <a href="https://www.brianstowell.name/WDV341/WildWestResort/index.php">Wild West Resort Home Page</a>
				    </button>
</header>
        <footer>
