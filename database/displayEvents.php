<?php
    ...
    */
    ...
    $sql = "SELECT events_name, events_description, events_presenter, events_date FROM wdv341_events WHERE events_name='WDV221 Intro JavaScript' ORDER BY events_name";
